              ...
              <FormItem>
                {getFieldDecorator('category')(
                  <TagSelect expandable actionsText={actionsTextMap}>
                    <TagSelect.Option value="cat1">Design</TagSelect.Option>
                    <TagSelect.Option value="cat2">Productivity</TagSelect.Option>
                    <TagSelect.Option value="cat3">Board</TagSelect.Option>
                    <TagSelect.Option value="cat4">Android</TagSelect.Option>
                    <TagSelect.Option value="cat5">Computer</TagSelect.Option>
